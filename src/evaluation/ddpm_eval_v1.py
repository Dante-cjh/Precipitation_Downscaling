...
from src.dataset.ddpm_dataset_v1 import RobustPrecipitationZScoreDataset
...
if __name__ == "__main__":
    ...
    model_dir = "../models/unet_diffusion_v1/"  # 模型保存目录
    save_dir = "../predictions/diffusion_unet_v1/results/"
