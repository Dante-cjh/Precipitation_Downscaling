...
def sample_diffusion(input_batch, model, device, dataset, num_steps=40,
    ...
    images_input = torch.cat([coarse_precip, dynamic, static], dim=1).to(device)
...
if __name__ == "__main__":
    ...
    model_dir = "../../models/unet_diffusion_v2/"  # 模型保存目录
    save_dir = "../../predictions/diffusion_unet_v2_new/results/"
